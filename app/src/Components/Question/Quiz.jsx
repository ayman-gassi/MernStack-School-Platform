    ...
    return(
        <>
	        <div class="p-6 shadow-md">
                ...
                <div class="mt-4">
                    <NavLink  to={`/Quiz/prepare/${props.Name}`} class="mt-2"> <button type="button" class="w-full text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300  font-medium rounded-lg text-sm  py-2.5 text-center">Acceder</button></NavLink>
                </div>
            </div>
        </>
    )
