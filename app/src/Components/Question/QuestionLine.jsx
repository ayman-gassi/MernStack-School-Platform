            ...
            <div class="flex flex-wrap -mx-2">
                <div class="px-2 w-1/4">
                    <label for="color-red" class="block text-gray-700 font-medium mb-2">
                        <input type="radio"  name={props.Question} class="mr-2"/>{props.choice1}
                    </label>
                </div>
                <div class="px-2 w-1/4">
                    <label for="color-blue" class="block text-gray-700 font-medium mb-2">
                        <input type="radio"  name={props.Question}  class="mr-2"/>{props.choice2}
                    </label>
                </div>
                <div class="px-2 w-1/4">
                    <label for="color-green" class="block text-gray-700 font-medium mb-2">
                        <input type="radio"  name={props.Question}  class="mr-2"/>{props.choice3}
                    </label>
                </div>
                <div class="px-2 w-1/4">
                    <label for="color-green" class="block text-gray-700 font-medium mb-2">
                        <input type="radio"  name={props.Question} class="mr-2"/>{props.choice4}
                    </label>
                </div>
            </div>
        </div>
